...
namespace CalorieRestAPIMySQL.Repositories
{
    ...
    public class CalorieRepository : ICalorieRepository
    {
        ...
        public ICollection<CalorieClass> GetCalories()
        {
            return _context.Calorie.ToList();
        }
        public CalorieClass GetCalorie(int id)
        {
        ...
        public bool CreateCalorie(CalorieClass Calorie)
        {
        ...
        public bool UpdateCalorie(CalorieClass Calorie)
        {
        ...
        {
            var calories = _context.Calorie.Where(calorie => calorie.Id == id);
            foreach( var calorie in calories)
            {
                _context.Remove(calorie);
            }
            return Save();
        }
