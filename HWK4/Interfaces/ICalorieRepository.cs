...
namespace CalorieRestAPIMySQL.Interfaces
{
    ...
    public interface ICalorieRepository
    {
        ...
        ICollection<CalorieClass> GetCalories();
        ...
        CalorieClass GetCalorie(int id);
        ...
        bool CreateCalorie(CalorieClass Calorie);
        ...
        bool UpdateCalorie(CalorieClass Calorie);
