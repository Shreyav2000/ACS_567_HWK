...
namespace CalorieRestAPI.Controllers
{
    ...
    public class CalorieController : ControllerBase
    {
        ...
        {
            Calorie calorie = _calorieRepository.GetCalorie(id);
        ...
        public IActionResult CreateCalorie([FromBody] Calorie calorie)
        {
        ...
        [ProducesResponseType(400)]
        [ProducesResponseType(404)]
        public IActionResult UpdateCalorie(int id, [FromBody] Calorie calorie)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public IActionResult DeleteCalorie(int id)
        {
            ...
            bool success = _calorieRepository.DeleteCalorie(calorie);
